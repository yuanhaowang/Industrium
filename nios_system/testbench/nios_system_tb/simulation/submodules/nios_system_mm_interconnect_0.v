...
// 
// Generated using ACDS version 14.0 209 at 2015.11.15.16:04:19
...
module nios_system_mm_interconnect_0 (
	...
	wire   [11:0] rsp_mux_src_channel;                                                                // rsp_mux:src_channel -> nios2_qsys_0_instruction_master_agent:rp_channel
	...
	wire   [11:0] rsp_mux_001_src_channel;                                                            // rsp_mux_001:src_channel -> nios2_qsys_0_data_master_agent:rp_channel
	...
	wire   [11:0] cmd_mux_src_channel;                                                                // cmd_mux:src_channel -> nios2_qsys_0_jtag_debug_module_agent:cp_channel
	...
	wire   [11:0] cmd_mux_001_src_channel;                                                            // cmd_mux_001:src_channel -> onchip_memory2_0_s1_agent:cp_channel
	...
	wire  [106:0] cmd_mux_002_src_data;                                                               // cmd_mux_002:src_data -> sdram_s1_agent:cp_data
	wire   [11:0] cmd_mux_002_src_channel;                                                            // cmd_mux_002:src_channel -> sdram_s1_agent:cp_channel
	...
	wire   [11:0] cmd_mux_004_src_channel;                                                            // cmd_mux_004:src_channel -> sdram_pll_pll_slave_agent:cp_channel
	...
	wire          cmd_mux_005_src_endofpacket;                                                        // cmd_mux_005:src_endofpacket -> jtag_uart_0_avalon_jtag_slave_agent:cp_endofpacket
	wire          cmd_mux_005_src_valid;                                                              // cmd_mux_005:src_valid -> jtag_uart_0_avalon_jtag_slave_agent:cp_valid
	wire          cmd_mux_005_src_startofpacket;                                                      // cmd_mux_005:src_startofpacket -> jtag_uart_0_avalon_jtag_slave_agent:cp_startofpacket
	wire  [106:0] cmd_mux_005_src_data;                                                               // cmd_mux_005:src_data -> jtag_uart_0_avalon_jtag_slave_agent:cp_data
	wire   [11:0] cmd_mux_005_src_channel;                                                            // cmd_mux_005:src_channel -> jtag_uart_0_avalon_jtag_slave_agent:cp_channel
	wire          cmd_mux_005_src_ready;                                                              // jtag_uart_0_avalon_jtag_slave_agent:cp_ready -> cmd_mux_005:src_ready
	...
	wire  [106:0] sdram_s1_agent_rp_data;                                                             // sdram_s1_agent:rp_data -> router_004:sink_data
	...
	wire  [106:0] jtag_uart_0_avalon_jtag_slave_agent_rp_data;                                        // jtag_uart_0_avalon_jtag_slave_agent:rp_data -> router_007:sink_data
	...
	wire  [106:0] cmd_demux_001_src10_data;                                                           // cmd_demux_001:src10_data -> cmd_mux_010:sink0_data
	...
	wire  [106:0] cmd_demux_001_src11_data;                                                           // cmd_demux_001:src11_data -> cmd_mux_011:sink0_data
	...
	wire  [106:0] rsp_demux_010_src0_data;                                                            // rsp_demux_010:src0_data -> rsp_mux_001:sink10_data
	...
	wire  [106:0] rsp_demux_011_src0_data;                                                            // rsp_demux_011:src0_data -> rsp_mux_001:sink11_data
	...
	wire  [106:0] cmd_demux_001_src2_data;                                                            // cmd_demux_001:src2_data -> crosser_001:in_data
	wire   [11:0] cmd_demux_001_src2_channel;                                                         // cmd_demux_001:src2_channel -> crosser_001:in_channel
	...
	wire   [11:0] crosser_001_out_channel;                                                            // crosser_001:out_channel -> cmd_mux_002:sink1_channel
	...
	wire   [11:0] rsp_demux_002_src1_channel;                                                         // rsp_demux_002:src1_channel -> crosser_003:in_channel
	...
	wire  [106:0] crosser_003_out_data;                                                               // crosser_003:out_data -> rsp_mux_001:sink2_data
	wire   [11:0] crosser_003_out_channel;                                                            // crosser_003:out_channel -> rsp_mux_001:sink2_channel
	...
	nios_system_mm_interconnect_0_router_007 router_010 (
	...
	nios_system_mm_interconnect_0_router_007 router_013 (
	...
	nios_system_mm_interconnect_0_cmd_mux_005 cmd_mux_007 (
		.clk                 (clk_0_clk_clk),                                    //       clk.clk
		.reset               (nios2_qsys_0_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios_system_mm_interconnect_0_cmd_mux_005 cmd_mux_008 (
		.clk                 (clk_0_clk_clk),                                    //       clk.clk
		.reset               (nios2_qsys_0_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios_system_mm_interconnect_0_cmd_mux_005 cmd_mux_009 (
		.clk                 (clk_0_clk_clk),                                    //       clk.clk
		.reset               (nios2_qsys_0_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios_system_mm_interconnect_0_cmd_mux_005 cmd_mux_010 (
		.clk                 (clk_0_clk_clk),                                    //       clk.clk
		.reset               (nios2_qsys_0_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios_system_mm_interconnect_0_cmd_mux_005 cmd_mux_011 (
		.clk                 (clk_0_clk_clk),                                    //       clk.clk
		.reset               (nios2_qsys_0_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios_system_mm_interconnect_0_rsp_demux_005 rsp_demux_006 (
		.clk                (clk_0_clk_clk),                                    //       clk.clk
		.reset              (nios2_qsys_0_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios_system_mm_interconnect_0_rsp_demux_005 rsp_demux_007 (
		.clk                (clk_0_clk_clk),                                    //       clk.clk
		.reset              (nios2_qsys_0_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios_system_mm_interconnect_0_rsp_demux_005 rsp_demux_008 (
		.clk                (clk_0_clk_clk),                                    //       clk.clk
		.reset              (nios2_qsys_0_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios_system_mm_interconnect_0_rsp_demux_005 rsp_demux_009 (
		.clk                (clk_0_clk_clk),                                    //       clk.clk
		.reset              (nios2_qsys_0_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios_system_mm_interconnect_0_rsp_demux_005 rsp_demux_010 (
		.clk                (clk_0_clk_clk),                                    //       clk.clk
		.reset              (nios2_qsys_0_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios_system_mm_interconnect_0_rsp_demux_005 rsp_demux_011 (
		.clk                (clk_0_clk_clk),                                    //       clk.clk
		.reset              (nios2_qsys_0_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
