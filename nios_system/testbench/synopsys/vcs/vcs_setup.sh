...
vcs -lca -timescale=1ps/1ps -sverilog +verilog2001ext+.v -ntb_opts dtm $ELAB_OPTIONS $USER_DEFINED_ELAB_OPTIONS \
  ...
  $QSYS_SIMDIR/nios_system_tb/simulation/submodules/altera_avalon_st_handshake_clock_crosser.v \
  $QSYS_SIMDIR/nios_system_tb/simulation/submodules/altera_avalon_st_clock_crosser.v \
  ...
  $QSYS_SIMDIR/nios_system_tb/simulation/submodules/nios_system_otg_hpi_data.v \
  $QSYS_SIMDIR/nios_system_tb/simulation/submodules/nios_system_otg_hpi_address.v \
  $QSYS_SIMDIR/nios_system_tb/simulation/submodules/nios_system_otg_hpi_cs.v \
  $QSYS_SIMDIR/nios_system_tb/simulation/submodules/nios_system_Keycode.v \
  $QSYS_SIMDIR/nios_system_tb/simulation/submodules/nios_system_jtag_uart_0.v \
  $QSYS_SIMDIR/nios_system_tb/simulation/submodules/nios_system_sdram_pll.vo \
  $QSYS_SIMDIR/nios_system_tb/simulation/submodules/nios_system_sysid_qsys_0.vo \
  $QSYS_SIMDIR/nios_system_tb/simulation/submodules/nios_system_sdram.v \
  $QSYS_SIMDIR/nios_system_tb/simulation/submodules/nios_system_onchip_memory2_0.v \
  $QSYS_SIMDIR/nios_system_tb/simulation/submodules/nios_system_nios2_qsys_0.v \
  ...
  $QSYS_SIMDIR/nios_system_tb/simulation/submodules/altera_conduit_bfm_0005.sv \
  $QSYS_SIMDIR/nios_system_tb/simulation/submodules/altera_conduit_bfm_0004.sv \
  $QSYS_SIMDIR/nios_system_tb/simulation/submodules/altera_conduit_bfm_0003.sv \
