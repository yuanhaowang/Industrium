...
if [ $SKIP_COM -eq 0 ]; then
  ...
  ncvlog -sv "$QSYS_SIMDIR/submodules/nios_system_mm_interconnect_0_rsp_mux_001.sv"         -work rsp_mux_001                                   -cdslib ./cds_libs/rsp_mux_001.cds.lib                                  
  ncvlog -sv "$QSYS_SIMDIR/submodules/altera_merlin_arbitrator.sv"                          -work rsp_mux                                       -cdslib ./cds_libs/rsp_mux.cds.lib                                      
  ncvlog -sv "$QSYS_SIMDIR/submodules/nios_system_mm_interconnect_0_rsp_mux.sv"             -work rsp_mux                                       -cdslib ./cds_libs/rsp_mux.cds.lib                                      
  ncvlog -sv "$QSYS_SIMDIR/submodules/nios_system_mm_interconnect_0_rsp_demux_005.sv"       -work rsp_demux_005                                 -cdslib ./cds_libs/rsp_demux_005.cds.lib                                
  ncvlog -sv "$QSYS_SIMDIR/submodules/nios_system_mm_interconnect_0_rsp_demux.sv"           -work rsp_demux                                     -cdslib ./cds_libs/rsp_demux.cds.lib                                    
  ncvlog -sv "$QSYS_SIMDIR/submodules/altera_merlin_arbitrator.sv"                          -work cmd_mux_005                                   -cdslib ./cds_libs/cmd_mux_005.cds.lib                                  
  ncvlog -sv "$QSYS_SIMDIR/submodules/nios_system_mm_interconnect_0_cmd_mux_005.sv"         -work cmd_mux_005                                   -cdslib ./cds_libs/cmd_mux_005.cds.lib                                  
  ncvlog -sv "$QSYS_SIMDIR/submodules/altera_merlin_arbitrator.sv"                          -work cmd_mux                                       -cdslib ./cds_libs/cmd_mux.cds.lib                                      
  ncvlog -sv "$QSYS_SIMDIR/submodules/nios_system_mm_interconnect_0_cmd_mux.sv"             -work cmd_mux                                       -cdslib ./cds_libs/cmd_mux.cds.lib                                      
  ncvlog -sv "$QSYS_SIMDIR/submodules/nios_system_mm_interconnect_0_cmd_demux_001.sv"       -work cmd_demux_001                                 -cdslib ./cds_libs/cmd_demux_001.cds.lib                                
  ncvlog -sv "$QSYS_SIMDIR/submodules/nios_system_mm_interconnect_0_cmd_demux.sv"           -work cmd_demux                                     -cdslib ./cds_libs/cmd_demux.cds.lib                                    
  ncvlog -sv "$QSYS_SIMDIR/submodules/nios_system_mm_interconnect_0_router_007.sv"          -work router_007                                    -cdslib ./cds_libs/router_007.cds.lib                                   
  ncvlog -sv "$QSYS_SIMDIR/submodules/nios_system_mm_interconnect_0_router_002.sv"          -work router_002                                    -cdslib ./cds_libs/router_002.cds.lib                                   
  ncvlog -sv "$QSYS_SIMDIR/submodules/nios_system_mm_interconnect_0_router_001.sv"          -work router_001                                    -cdslib ./cds_libs/router_001.cds.lib                                   
  ncvlog -sv "$QSYS_SIMDIR/submodules/nios_system_mm_interconnect_0_router.sv"              -work router                                        -cdslib ./cds_libs/router.cds.lib                                       
  ...
  ncvlog     "$QSYS_SIMDIR/submodules/nios_system_mm_interconnect_0.v"                      -work mm_interconnect_0                             -cdslib ./cds_libs/mm_interconnect_0.cds.lib                            
  ncvlog     "$QSYS_SIMDIR/submodules/nios_system_otg_hpi_data.v"                           -work otg_hpi_data                                  -cdslib ./cds_libs/otg_hpi_data.cds.lib                                 
  ncvlog     "$QSYS_SIMDIR/submodules/nios_system_otg_hpi_address.v"                        -work otg_hpi_address                               -cdslib ./cds_libs/otg_hpi_address.cds.lib                              
  ncvlog     "$QSYS_SIMDIR/submodules/nios_system_otg_hpi_cs.v"                             -work otg_hpi_cs                                    -cdslib ./cds_libs/otg_hpi_cs.cds.lib                                   
  ncvlog     "$QSYS_SIMDIR/submodules/nios_system_Keycode.v"                                -work Keycode                                       -cdslib ./cds_libs/Keycode.cds.lib                                      
  ncvlog     "$QSYS_SIMDIR/submodules/nios_system_jtag_uart_0.v"                            -work jtag_uart_0                                   -cdslib ./cds_libs/jtag_uart_0.cds.lib                                  
  ncvlog     "$QSYS_SIMDIR/submodules/nios_system_sdram_pll.vo"                             -work sdram_pll                                     -cdslib ./cds_libs/sdram_pll.cds.lib                                    
  ...
  ncvlog     "$QSYS_SIMDIR/submodules/nios_system_onchip_memory2_0.v"                       -work onchip_memory2_0                              -cdslib ./cds_libs/onchip_memory2_0.cds.lib                             
  ncvlog     "$QSYS_SIMDIR/submodules/nios_system_nios2_qsys_0.v"                           -work nios2_qsys_0                                  -cdslib ./cds_libs/nios2_qsys_0.cds.lib                                 
